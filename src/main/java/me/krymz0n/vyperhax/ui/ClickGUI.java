package me.krymz0n.vyperhax.ui;
...
public class ClickGUI extends MinecraftHUDGUI {
    ...
    private class ThemeSelector implements IThemeMultiplexer {
        ...
        public ThemeSelector (IInterface inter) {
            ...
            addTheme(ClickGUIModule.Theme.Clear,new ClearTheme(new ThemeScheme(ClickGUIModule.Theme.Clear),()->clearGradient.getValue(),9,3,1,": "+Formatting.GRAY));
        }
